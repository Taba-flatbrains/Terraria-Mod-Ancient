using Ancient.src.Code.Projectiles.Flails;
using System;
...
{
    internal class HeavyFlail : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.damage = 16; // The damage of your flail, this is dynamically adjusted in the projectile code.
            Item.noUseGraphic = true; // This makes sure the item does not get shown when the player swings his hand
            Item.shoot = ModContent.ProjectileType<HeavyFlailProjectile>(); // The flail projectile
            ...
            Item.value = Item.sellPrice(silver: 80); // Sells for 1 gold 50 silver
