...
{
    internal class TormentProjectile : ModProjectile
    {
        ...
        {
            target.AddBuff(ModContent.BuffType<TormentDebuff>(), 240);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int i = 0; i < list.Count - 1; i++)
            {
                ...
                {
                    if (i == list.Count - 2)
                        Dust.NewDust(pos - new Vector2(25, 25), 50, 50, ModContent.DustType<DarkSteelWeaponsDust>());
                }
