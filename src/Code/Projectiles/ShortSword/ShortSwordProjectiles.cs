...
namespace Ancient.src.Code.Projectiles.ShortSword
{
    internal abstract class ShortSwordProjectiles : ModProjectile
    {
        public abstract int FadeInDuration { get; }
        public abstract int FadeOutDuration { get; }
        public abstract int TotalDuration { get; }
        public virtual float CollisionWidth => 10f * Projectile.scale;
    ...
    internal class SteelShortSwordProjectile : ShortSwordProjectiles
    {
        public override int FadeInDuration => 5;
        public override int FadeOutDuration => 3;

        public override int TotalDuration => 13;

    }

    internal class BronzeShortSwordProjectile : ShortSwordProjectiles
    {
        public override int FadeInDuration => 5;
        public override int FadeOutDuration => 3;
        public override int TotalDuration => 11;
