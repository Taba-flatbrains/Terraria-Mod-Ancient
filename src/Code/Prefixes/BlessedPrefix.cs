...
{
    internal class BlessedPrefix : ModPrefix
    {
        ...
        {
            yield return new TooltipLine(Mod, "CritChance", "+4% melee attack speed")
            {
                IsModifier = true, // Sets the color to the positive modifier color.
            };
            yield return new TooltipLine(Mod, "CritChance", "+40 mana")
            {
                IsModifier = true, // Sets the color to the positive modifier color.
            };
        }
